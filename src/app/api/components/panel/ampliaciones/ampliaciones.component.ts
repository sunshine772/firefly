...
@Component({
  selector: 'app-ampliaciones',
  templateUrl: './ampliaciones.component.html',
  styleUrls: ['./ampliaciones.component.scss'],
  providers: [MessageService, DialogService],
})
export class AmpliacionesComponent {
  ...
  listar(): void {
    this.ampliacionesService.listar().subscribe((res) => {
      console.log(res);
  ...
  modalModificar(ampliacion: Ampliaciones) {
    this.modalMod = true;
    this.Mod.reset();
    this.submittedMod = false;
  }
  modalHabilitar(ampliacion: Ampliaciones) {
    this.modalEnable = true;
  }
  modalDeshabilitar(ampliacion: Ampliaciones) {
